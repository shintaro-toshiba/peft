...
output_dir=lsf_scripts/llama3_math/lora/tmp
...
template_train_file=lsf_scripts/llama3_math/lora/train_llama3_lora_math.sh
template_evaluate_file=lsf_scripts/llama3_math/lora/evaluate_llama3_lora_math.sh
