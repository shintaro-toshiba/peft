...
#BSUB -q cal_h8
#BSUB -P ama02
#BSUB -J train_roberta_dora_qnli
#BSUB -n 1
#BSUB -R "span[ptile=1]"
#BSUB -gpu "num=4:j_exclusive=yes"
#BSUB -rn
#BSUB -o lsf_logs/train_roberta/qnli/dora.%J.log
#BUSB -o lsf_logs/train_roberta/qnli/dora.%J.err
...
singularity run --nv uv-cuda12.sif \
    uv run torchrun --standalone --nproc_per_node=$NUM_GPUS_PER_NODE \
        ...
        --save_total_limit 3 \
        --output_dir hf_models/dora_${MODEL_NAME}/${TASK_NAME}/seed${SEED}_lr${LR}
