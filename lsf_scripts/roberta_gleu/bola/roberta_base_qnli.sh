...
#BSUB -q cal_h8
#BSUB -P ama02
#BSUB -J train_roberta_bola_qnli
#BSUB -n 16
#BSUB -R "span[hosts=1]"
#BSUB -gpu "num=1:j_exclusive=yes"
#BSUB -rn
#BSUB -o lsf_logs/train_roberta/qnli/bola.%J.log
#BSUB -e lsf_errs/train_roberta/qnli/bola.%J.err

module load nvhpc-hpcx-cuda12/24.11
module load singularity/ce_4.2.1
module load openmpi/4.1.7-cuda12.4-ucx1.17.0-c

mkdir -p lsf_logs/train_roberta/qnli
mkdir -p lsf_errs/train_roberta/qnli
