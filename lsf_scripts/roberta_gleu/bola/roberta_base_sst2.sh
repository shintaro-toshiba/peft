...
#BSUB -q cal_h8
#BSUB -P ama02
#BSUB -J train_roberta_bola_sst2
#BSUB -n 16
#BSUB -R "span[hosts=1]"
#BSUB -gpu "num=1:j_exclusive=yes"
#BSUB -rn
#BSUB -o lsf_logs/train_roberta/sst2/bola.%J.log
#BSUB -e lsf_errs/train_roberta/sst2/bola.%J.err
...
mkdir -p lsf_errs/train_roberta/sst2
