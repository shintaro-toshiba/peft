...
#BSUB -q cal_h8
#BSUB -P ama02
#BSUB -J train_roberta_lora_mrpc
#BSUB -n 1
#BSUB -R "span[ptile=1]"
#BSUB -gpu "num=4:j_exclusive=yes"
#BSUB -rn
#BSUB -o lsf_logs/train_roberta/mrpc/lora.%J.log
#BSUB -e lsf_logs/train_roberta/mrpc/lora.%J.err

module load nvhpc-hpcx-cuda12/24.11
module load singularity/ce_4.2.1
module load openmpi/4.1.7-cuda12.4-ucx1.17.0-c

mkdir -p lsf_logs/train_roberta/mrpc
...
singularity run --nv uv-cuda12.sif \
    uv run torchrun --standalone --nproc_per_node=$NUM_GPUS_PER_NODE \
        ...
        --save_total_limit 3 \
        --output_dir hf_models/lora_${MODEL_NAME}/${TASK_NAME}/seed${SEED}_lr${LR}
