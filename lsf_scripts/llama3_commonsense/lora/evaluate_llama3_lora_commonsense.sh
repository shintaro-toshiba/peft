...
#BSUB -q cal_h8
#BSUB -P ama02
#BSUB -J evaluate_llama3_lora_commonsense
#BSUB -n 1
#BSUB -R "span[ptile=1]"
#BSUB -gpu "num=8:j_exclusive=yes"
#BSUB -rn
#BSUB -o lsf_logs/evaluate_llama3/commonsense/lora.%J.log
#BUSB -e lsf_logs/evaluate_llama3/commonsense/lora.%J.err
...
PEFT_NAME_OR_PATH=hf_models/${MODEL_NAME}/commonsense/lora/seed${SEED}_lr${LR}
