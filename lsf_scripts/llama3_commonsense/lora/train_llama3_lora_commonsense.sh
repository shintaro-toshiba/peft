...
#BSUB -q cal_h8
#BSUB -P ama02
#BSUB -J train_llama3_lora_commonsense
#BSUB -n 1
#BSUB -R "span[ptile=1]"
#BSUB -gpu "num=8:j_exclusive=yes"
#BSUB -rn
#BSUB -o lsf_logs/train_llama3/commonsense/lora.%J.log
#BUSB -o lsf_logs/train_llama3/commonsense/lora.%J.err
...
DATA_PATHS=$HOME/projects/llm_adapters/ft-training_set/commonsense_170k.json
SEED=0
BATCH_SIZE=8
LR=5e-4
...
singularity run --nv uv-cuda12.sif \
    uv run torchrun --standalone --nproc_per_node=$NUM_GPUS_PER_NODE \
        experiments/llama3_commonsense/train_lora_commonsense.py \
        ...
        --learning_rate $LR \
        --num_train_epochs 3 \
        --output_dir hf_models/${MODEL_NAME}/commonsense/lora/seed${SEED}_lr${LR}
