...
#BSUB -q cal_h8
#BSUB -P ama02
#BSUB -J train_llama3_dora_commonsense
#BSUB -n 1
#BSUB -R "span[ptile=1]"
#BSUB -gpu "num=8:j_exclusive=yes"
#BSUB -rn
#BSUB -o lsf_logs/train_llama3/commonsense/dora.%J.log
#BUSB -o lsf_logs/train_llama3/commonsense/dora.%J.err
...
singularity run --nv uv-cuda12.sif \
    uv run torchrun --standalone --nproc_per_node=$NUM_GPUS_PER_NODE \
        ...
        --learning_rate $LR \
        --num_train_epochs 3 \
        --output_dir hf_models/${MODEL_NAME}/commonsense/dora/seed${SEED}_lr${LR}
